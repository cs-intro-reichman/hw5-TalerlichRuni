...
public class Scrabble {
	...
	public static boolean isWordInDictionary(String word) {
		...
		if (dword.equals(word)) return true;
		}
		return false;
	}
	...
	public static String createHand() {
		String play = MyString.randomStringOfLetters(HAND_SIZE-2);
		char a = 'a';
		char e = 'e';
		play =MyString.insertRandomly(a, play);
		play =MyString.insertRandomly(e, play);
		return play;
	}
